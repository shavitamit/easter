...
<script type="text/javascript" src="scripts.js?<?php echo filemtime("scripts.js") ; ?>"></script>
<script type="text/javascript" src="form.js?<?php echo filemtime("form.js") ; ?>"></script>
